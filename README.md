...
The code has been adapted from https://github.com/john-hewitt/structural-probes, and comments are written at places
where some minor changes have been made due to version issues of the tools used.
